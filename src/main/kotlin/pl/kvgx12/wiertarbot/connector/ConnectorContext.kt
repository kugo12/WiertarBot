...
abstract class ConnectorContext(
    ...
    abstract suspend fun upload(files: Iterable<String>, voiceClip: Boolean = false): Iterable<PyObject>?
    ...
    fun pyUploadRaw(files: Iterable<PyObject>, voiceClip: Boolean = false) = intoFuture { uploadRaw(files, voiceClip) }
    ...
    fun pyUpload(files: Iterable<String>, voiceClip: Boolean = false) = intoFuture { upload(files, voiceClip) }
}